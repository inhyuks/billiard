...
<div class="container">
	...
	<body>
		...
		<script src="<%=cp%>/resources/bootstrap/vendor/jquery/jquery.min.js"></script>
		<script
			src="<%=cp%>/resources/bootstrap/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
		<!-- Plugin JavaScript -->
		<script
			src="<%=cp%>/resources/bootstrap/vendor/jquery-easing/jquery.easing.min.js"></script>

		<!-- Custom scripts for this template -->
		<script src="<%=cp%>/resources/bootstrap/js/grayscale.min.js"></script>
